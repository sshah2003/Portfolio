...
export default function Hero() {
  return (
    <section className="pf-hero" id="home">
      ...
      <h1 className="pf-hero-name">Sohil Shah</h1>

      <p className="pf-hero-title">
        <strong>iOS & Full-Stack Engineer</strong> — building products people love
      </p>

      <p className="pf-hero-location">Washington D.C. Area</p>

      <div className="pf-social-row">
        <a
          href="https://x.com/TheSohilShah"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/sohil-shah-1b1023122"
          target="_blank"
          rel="noopener noreferrer"
          className="pf-social-btn"
        >
        ...
        <a href="mailto:sshah55@gmu.edu" className="pf-social-btn">
          <MailIcon /> Email
        </a>
      </div>
